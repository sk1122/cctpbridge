...
export const ChainSelect = ({ payingToken }: { payingToken: boolean }) => {
  ...
  return (
    ...
    >
      <Select.Trigger
        className="inline-flex items-center justify-center rounded-lg px-[15px] text-[13px] leading-none h-[35px] gap-[5px] bg-[#070708] text-white text-violet11 shadow-[0_2px_10px] shadow-black/10 hover:bg-mauve3 focus:shadow-[0_0_0_2px] focus:shadow-black data-[placeholder]:text-white outline-none"
        aria-label="Food"
      >
